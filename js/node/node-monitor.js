            ...
            <table width="100%" style="table-layout: fixed">
                <tbody id="chart-content">
                    <tr>
                        ...
                        <div>
                            <td style="word-wrap: break-word;" valign="top" width="50%"><canvas width="200" id="myChartOwlh"></canvas></td>
                        </div>
                    </tr>
                    <tr>
                        <div>
                            <td style="word-wrap: break-word;" valign="top" width="50%"><canvas width="300" height="300" style="margin: 0 auto; margin-top:50px" id="myChartMem"></canvas></td>
                        </div>
                        <div>
                            <td style="word-wrap: break-word;" valign="top" width="50%"><canvas width="300" height="300" style="margin: 0 auto; margin-top:50px" id="myChartSto"></canvas></td>
                        </div>
                    </tr>
                </tbody>
            </table>
        ...
        .then(function (response) {
            ...
            if (response.data.permissions == "none") {
                ...
                if (response.data.ack == "false") {
                    ...
                    var cpu_chart = Chart.getChart('myChartPercentage');
                    if (cpu_chart) {
                        cpu_chart.destroy();
                    }
                    ...
                    var owlh_chart = Chart.getChart('myChartOwlh');
                    if (owlh_chart) {
                        owlh_chart.destroy();
                    }
                    ...
                    var mem_chart = Chart.getChart('myChartMem');
                    if (mem_chart) {
                        mem_chart.destroy();
                    }
                    ...
                    var Sto_chart = Chart.getChart('myChartSto');
                    if (Sto_chart) {
                        Sto_chart.destroy();
                    }
